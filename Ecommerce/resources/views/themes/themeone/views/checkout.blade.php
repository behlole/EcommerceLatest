                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <form name="signup" enctype="multipart/form-data" class="form-validate" action="{{ URL::to('/checkout_shipping_address')}}" method="post">
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control field-validate" id="firstname" name="firstname" value="{{session('shipping_address')->firstname}}">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control field-validate" id="lastname" name="lastname" value="{{session('shipping_address')->lastname}}">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control field-validate" id="company" name="company" value=" {{session('shipping_address')->company}}">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control field-validate" id="street" name="street" value="{{session('shipping_address')->street}}">
                                  ...
                                  <select class="form-control field-validate" id="entry_country_id" onChange="getZones();" name="countries_id">
                                      ...
                                      @if(count($result['countries'])>0)
                                        @foreach($result['countries'] as $countries)
                                            <option value="{{$countries->countries_id}}"  @if(session('shipping_address')->countries_id == $countries->countries_id) selected  @endif >{{$countries->countries_name}}</option>
                                        @endforeach
                                      @endif
                                  </select>
                                      ...
                                      <option value="" selected>@lang('website.Select State')</option>
                                       @if(count($result['zones'])>0)
                                        @foreach($result['zones'] as $zones)
                                            <option value="{{$zones->zone_id}}"  @if(session('shipping_address')->zone_id == $zones->zone_id) selected @endif >{{$zones->zone_name}}</option>
                                        @endforeach
                                      @endif

                                       <option value="Other"  @if(session('shipping_address')->zone_id == 'Other') selected @endif >@lang('website.Other')</option>
                                </select>
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control field-validate" id="city" name="city" value="{{session('shipping_address')->city}}">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="postcode" name="postcode" value="{{session('shipping_address')->postcode}}">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="delivery_phone" name="delivery_phone" value="{{session('shipping_address')->delivery_phone}}">
                      ...
                      <div class="tab-pane fade @if(session('step') == 1) show active @endif" id="pills-billing" role="tabpanel" aria-labelledby="billing-tab">
                        ...
                        <div class="form-row">
                          <div class="form-group col-md-6">
                            <label for="firstName">@lang('website.First Name')</label>
                            <input type="text" class="form-control same_address"  @if(session('billing_address')->same_billing_address==1) readonly @else readonly @endif  id="billing_firstname" name="billing_firstname" value="{{session('billing_address')->billing_firstname}}">
                            <span class="help-block error-content" hidden>@lang('website.Please enter your first name')</span>
                          </div>
                          <div class="form-group col-md-6">
                            <label for="lastName">@lang('website.Last Name')</label>
                            <input type="text" class="form-control same_address"  @if(session('billing_address')->same_billing_address==1)  @else readonly  @endif id="billing_lastname" name="billing_lastname" value="{{session('billing_address')->billing_lastname}}">
                            <span class="help-block error-content" hidden>@lang('website.Please enter your last name')</span>
                          </div>
                          <div class="form-group col-md-6">
                            <label for="firstName">@lang('website.Company')</label>
                            <input type="text" class="form-control same_address"  @if(session('billing_address')->same_billing_address==1) readonly @else readonly @endif  id="billing_company" name="billing_company" value="{{session('billing_address')->billing_company}}">
                            <span class="help-block error-content" hidden>@lang('website.Please enter your company name')</span>
                          </div>
                          <div class="form-group col-md-6">
                            <label for="firstName">@lang('website.Address')</label>
                            <input type="text" class="form-control same_address"  @if(session('billing_address')->same_billing_address==1)  @else readonly @endif  id="billing_street" name="billing_street" value={{session('billing_address')->billing_street}}">
                            <span class="help-block error-content" hidden>@lang('website.Please enter your address')</span>
                          </div>
                          <div class="form-group col-md-6">
                            <label for="lastName">@lang('website.Country')</label>
                              <select class="form-control same_address_select" id="billing_countries_id"  onChange="getBillingZones();" name="billing_countries_id"  @if(session('billing_address')->same_billing_address==1) disabled  @else disabled @endif  >
                                  <option value=""  >@lang('website.Select Country')</option>
                                  @if(count($result['countries'])>0)
                                    @foreach($result['countries'] as $countries)
                                        <option value="{{$countries->countries_id}}" @if(session('billing_address')->billing_countries_id == $countries->countries_id) selected @endif >{{$countries->countries_name}}</option>
                                    @endforeach
                                  @endif
                              </select>
                              <span class="help-block error-content" hidden>@lang('website.Please select your country')</span>
                          ...
                          <div class="form-group col-md-6">
                            <label for="firstName">@lang('website.State')</label>
                            <select class="form-control same_address_select" id="billing_zone_id" name="billing_zone_id" @if(session('billing_address')->same_billing_address==1) disabled @else disabled @endif  >
                                  <option value="" >@lang('website.Select State')</option>
                                  @if(count($result['zones'])>0)
                                    @foreach($result['zones'] as $key=>$zones)
                                        <option value="{{$zones->zone_id}}"  @if(session('billing_address')->billing_zone_id == $zones->zone_id) selected @endif >{{$zones->zone_name}}</option>
                                    @endforeach
                                  @endif
                                    <option value="Other"  @if(session('billing_address')->billing_zone_id == 'Other') selected @endif>@lang('website.Other')</option>
                              </select>
                              <span class="help-block error-content" hidden>@lang('website.Please select your state')</span>
                          </div>
                          <div class="form-group col-md-6">
                            <label for="lastName">@lang('website.City')</label>
                            <input type="text" class="form-control same_address" @if(session('billing_address')->same_billing_address==1) readonly @else readonly @endif  id="billing_city" name="billing_city" value="{{session('billing_address')->billing_city}}">
                            <span class="help-block error-content" hidden>@lang('website.Please enter your city')</span>
                          </div>
                          <div class="form-group col-md-6">
                            <label for="lastName">@lang('website.Zip/Postal Code')</label>
                            <input type="text" class="form-control same_address"  @if(session('billing_address')->same_billing_address==1) readonly  @else readonly @endif  id="billing_zip" name="billing_zip" value="{{session('billing_address')->billing_zip}}">
                            <span class="help-block error-content" hidden>@lang('website.Please enter your Zip/Postal Code')</span>
                          </div>

                          <div class="form-group col-md-6">
                            <label for="lastName">@lang('website.Phone Number')</label>
                            <input type="text" class="form-control same_address"  @if(session('billing_address')->same_billing_address==1) readonly  @else readonly @endif  id="billing_phone" name="billing_phone" value="{{session('billing_address')->billing_phone}}">
                            <span class="help-block error-content" hidden>@lang('website.Please enter your valid phone number')</span>
                          </div>
                        </div>
                        <div class="form-group">
                            <div class="form-check">
                              <label class="form-check-label">
                                  <input  class="form-check-input" id="same_billing_address" value="1" type="checkbox" name="same_billing_address" @if(session('billing_address')->same_billing_address==1) checked  @else checked  @endif > @lang('website.Same shipping and billing address')
                              </label>
                            </div>
                        </div>
                        <div class="button"><button type="submit" class="btn btn-dark"> @lang('website.Continue')</button></div>
