...
class AdminCategoriesController extends Controller
{
	...
	public function addnewcategory(Request $request){
		...
		if($request->hasFile('newImage') and in_array($request->newImage->extension(), $extensions)){
			...
			$image->move('images/category_images/', $fileName);
			$uploadImage = 'images/category_images/'.$fileName; 
		}	else{
			$uploadImage = '';
		}	
		...
		if($request->hasFile('newIcon') and in_array($request->newIcon->extension(), $extensions)){
			...
			$icon->move('images/category_icons/', $iconName);
			$uploadIcon = 'images/category_icons/'.$iconName; 
		}	else{
			$uploadIcon = '';
		}	
